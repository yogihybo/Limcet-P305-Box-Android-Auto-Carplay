...
- **Linux or WSL build environment.** This project already requires WSL for `u-boot-tools`
  (`mkimage`) elsewhere (`docs/UBOOT_REVERSE_ENGINEERING.md` §8) — same requirement applies here, more so
...
Following this project's existing safety pattern (`docs/UBOOT_REVERSE_ENGINEERING.md` §4, §7 — NAND
