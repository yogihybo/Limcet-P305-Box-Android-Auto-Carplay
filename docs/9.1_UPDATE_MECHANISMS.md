# 9.1 Update Mechanisms — Reference

Background doc for [README §9.0 Update Mechanisms](../README.md#90-update-mechanisms).

**Status:** Reference — full quick-start steps, the `update` script keyword list, and safety
detail behind §9.0's summary.
...
Use `bash build_update.sh` (see [§10.0 Build & Flash Tool](../README.md#100-build--flash-tool) / [`docs/10.1_BUILD_FLASH_TOOL.md`](10.1_BUILD_FLASH_TOOL.md)) to select partitions and generate the SD package — it does the build and package generation for Steps 1–2 in one interactive session.
