...
(disassembly trace: [`docs/MSNCOREAPP_REVIEW.md`](../docs/MSNCOREAPP_REVIEW.md)) to get a root
...
- [`docs/MSNCOREAPP_REVIEW.md`](../docs/MSNCOREAPP_REVIEW.md) — disassembly trace of the
