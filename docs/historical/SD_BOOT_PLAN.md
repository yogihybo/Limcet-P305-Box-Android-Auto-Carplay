...
> [Booting from SD Card or USB](../../README.md#60-booting-stock-kernel-from-sd-card-or-usb-non-destructive)
...
[`docs/7.1_UBOOT_BUILD_GUIDE.md`](../7.1_UBOOT_BUILD_GUIDE.md) — read that before acting on this section.
...
See [`docs/7.1_UBOOT_BUILD_GUIDE.md`](../7.1_UBOOT_BUILD_GUIDE.md) for the actual clone URL, full config-delta
