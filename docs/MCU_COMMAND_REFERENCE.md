...
| `0xFF` | System state reset | Sub-id `0x00`-`0x09` all no-ops, only `0x7F` acts | **Not found** — same exhaustive check as `0x84`/`0x85`, same open gap | ✅ dispatch confirmed / partial trace beyond the `0x7F` gate |
