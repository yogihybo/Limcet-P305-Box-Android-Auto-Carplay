...
Background doc for [README §8.0 NAND Partition Layout](../README.md#80-nand-partition-layout) — the `userdata` partition.
...
See [`8.1_PARTITION_LAYOUT.md`](8.1_PARTITION_LAYOUT.md) for complete offset table.