# 1.10 Settings Reference

Background doc for [README §1.0 Hardware](../README.md#10-hardware) — Product identity row of the Software table.
...
4. Use `ScreenType` + `ResolutionType` to select and apply the matching
   **`arkdata` display preset** → panel comes up (see
   [`docs/1.7_DISPLAY_SUBSYSTEM.md`](1.7_DISPLAY_SUBSYSTEM.md#arkdata_variantsmd)).
