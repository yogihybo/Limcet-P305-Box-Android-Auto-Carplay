# 11.1 Build & Flash Tool — Reference

Background doc for [README §11.0 Build & Flash Tool](../README.md#110-build--flash-tool).

**Status:** Reference — menu layout, standalone scripts, and dependency detail behind §11.0's
summary.
