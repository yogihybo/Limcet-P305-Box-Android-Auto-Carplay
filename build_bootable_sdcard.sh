...
# when the NAND env is unreadable (patched U-Boot). Matches firmware_source/env/uboot-env.txt.
...
rcs = re.sub(
    r'insmod /lib/modules/3\.4\.0/firmware_source/kernel/drivers/input/touchscreen/ark1680_ts\.ko',
    'modprobe ark1680_ts 2>/dev/null || true  # 3.4.0 driver not built for 4.19.192 yet',
    rcs
)
rcs = re.sub(
    r'insmod /lib/modules/3\.4\.0/firmware_source/kernel/drivers/input/touchscreen/gt9xx/gt9xx\.ko',
...
NEW_WIFI = """    # Try modprobe first -- uses modules.dep for 4.19.192
    ...
    modprobe rtl8811cu 2>/dev/null || {
        ...
        KVER=$(uname -r)
        for ko in \\
            /lib/modules/${KVER}/firmware_source/kernel/drivers/net/wireless/realtek/rtl8821cs/rtl8821cs.ko \\
            /lib/modules/${KVER}/firmware_source/kernel/drivers/net/wireless/realtek/rtlwifi/rtl8192cu/rtl8192cu.ko \\
            /lib/modules/${KVER}/firmware_source/kernel/drivers/net/wireless/realtek/rtl8811cu/rtl8811cu.ko \\
            /lib/modules/${KVER}/firmware_source/kernel/drivers/net/wireless/realtek/rtl8xxxu/rtl8xxxu.ko; do
