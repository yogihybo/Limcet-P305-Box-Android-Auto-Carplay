#!/usr/bin/env python3
"""
convert_bootlogo.py — Convert the dumped bootlogo JPEG into a raw OSD framebuffer
...
Usage:
  python3 convert_bootlogo.py bootlogo.jpg bootlogo.raw
  python3 convert_bootlogo.py bootlogo.jpg bootlogo.raw --width 800 --height 480
"""
