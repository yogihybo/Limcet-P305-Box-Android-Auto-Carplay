# 10.1 Build & Flash Tool — Reference

Background doc for [README §10.0 Build & Flash Tool](../README.md#100-build--flash-tool).

**Status:** Reference — menu layout, standalone scripts, and dependency detail behind §10.0's
summary.
