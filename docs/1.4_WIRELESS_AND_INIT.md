...
**Current state, top to bottom:** WiFi (RTL8811CU, USB) and Bluetooth (RTL8762BTV, HS-UART)
are both hardware-confirmed working, including wireless CarPlay/Android Auto end to end.
