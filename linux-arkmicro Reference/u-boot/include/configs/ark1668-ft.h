...
/* spi base address */
#define CONFIG_SYS_SPI_BASE			0xe4100000
...
#define NANDARGS \
	...
	"spiflashburn=sf probe 0 30000000 0; " \
		"if fatload ${update_dev_type} ${update_dev_part} ${loadaddr} spinor.bin; " \
		"then sf erase 0 ${filesize}; " \
