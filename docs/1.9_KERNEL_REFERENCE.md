# 1.9 Kernel Reference

Background doc for [README §1.0 Hardware](../README.md#10-hardware) — Kernel row of the Software table.
...
contradiction flagged in `docs/4.1_UBOOT_REVERSE_ENGINEERING.md` §6 (that
...
> here and matches [`KERNEL.md`](1.9_KERNEL_REFERENCE.md#reverse-camera--ahd-video-decoder)**, which
...
>   `drivers/media/i2c/rn6752.c` exists in the full ArkMicro 4.19 tree — see
>   [`vendor_source/README.md`](../vendor_source/README.md) for BSP tree details.)
>
