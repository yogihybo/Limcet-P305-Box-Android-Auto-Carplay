...
**not** part of this project's build (see `docs/14.1_SOURCES.md`), looking for anything
...
(`/home/osboxes/Downloads/linux-arkmicro`, see `docs/14.1_SOURCES.md`), not in this repo — see
...
- Vendor source trees referenced: `/home/osboxes/Downloads/ark1668ed-bsp`,
  ...
  personal Downloads on this machine (see `docs/14.1_SOURCES.md` for how this project usually
