...
Background doc for [README §4.0 NAND Partition Layout](../README.md#40-nand-partition-layout) — the `userdata` partition.
...
See [`4.1_PARTITION_LAYOUT.md`](4.1_PARTITION_LAYOUT.md) for complete offset table.