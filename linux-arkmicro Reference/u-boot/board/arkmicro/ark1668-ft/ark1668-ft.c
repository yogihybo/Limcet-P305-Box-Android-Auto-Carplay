...
#define rGPIO_MODA				(*(volatile unsigned int *)(0xe4600000))
#define rGPIO_RDATAA			(*(volatile unsigned int *)(0xe4600004))

#define rPWM3_EN				(*(volatile unsigned int *)(0xe4d00030))
#define rPWM3_DUTY				(*(volatile unsigned int *)(0xe4d00034))
#define rPWM3_CNTR				(*(volatile unsigned int *)(0xe4d00038))
...
static void led_pwm_blink(void)
{
	/* select pwm3 pad */
	rSYS_PAD_CTRL09 &= ~(3 << 22);
	rSYS_PAD_CTRL09 |= 1 << 22;

	rPWM3_CNTR = PWM_CLK / 10;
	rPWM3_DUTY = rPWM3_CNTR / 2;
	rPWM3_EN = 1;
}
