...
## Overview
Consolidated document containing: MSNCOREAPP_REVIEW.md, MSNCOREAPP_DECONSTRUCTION.md, UI_RE13.1_SOURCES.md, LIBMCUCENTER_UNPACK.md
...
fully data-editable (see [`UI_RE13.1_SOURCES.md`](3.1_UI_AND_APP_ANALYSIS.md)).
...
security disassembly) and [`UI_RE13.1_SOURCES.md`](3.1_UI_AND_APP_ANALYSIS.md) (style + sprites).


## UI_RE13.1_SOURCES.md
